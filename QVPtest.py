...
#Filter out scatterers associated with rho_hv less than 0.7
    
zdr_avg_f = np.ones((1441,28))*np.nan
kdp_avg_f = np.ones((1441,28))*np.nan    
zh_avg_f = np.ones((1441,28))*np.nan    


zdr_avg_lib_f = np.ones((1441,28))*np.nan
kdp_avg_lib_f = np.ones((1441,28))*np.nan
zh_avg_lib_f = np.ones((1441,28))*np.nan    



for i in range(zdr_avg.shape[0]):
    for j in range(zdr_avg.shape[1]):
